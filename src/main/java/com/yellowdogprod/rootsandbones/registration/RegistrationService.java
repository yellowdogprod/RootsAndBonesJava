...
import com.yellowdogprod.rootsandbones.email.EmailSender;
...
import com.yellowdogprod.rootsandbones.user.UserRole;
...
public class RegistrationService {
	...
	public ResponseBean<User> register(RegistrationRequest request) {
		...
		if(!isValidEmail) {
			return ResponseBean.error("Email not valid");
		}
		...
		ResponseBean<User> resp = userService.login(request.getUsername(), request.getPassword());
		Profile profile = resp.getResult().getProfile();
		resp.setMessage("Account created successfully, check your email for activation link.");
		return resp;
	}
